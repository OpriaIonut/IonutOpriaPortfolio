...
export class ShaderProjectsPanel
{
    ...
    private createElements(pageParent: HTMLDivElement)
    {
        ...
        this._cells.push(new CellWithPreview(parentNode, "Signed Distance Field", cellsPerWidth, "SDF", "images/shaders/SDF.jpg", () => { shaderVisualizer.activateView(ShaderSceneType.SDF); }));
