export class AboutMePanel
{
    ...
    private createElements(parentElem: HTMLDivElement)
    {
        ...
        Hobbies: 3D modelling, cosplaying, learning Japanese, going on mountain hikes, going to rock concerts, playing games and generally trying new experiences.<br>
