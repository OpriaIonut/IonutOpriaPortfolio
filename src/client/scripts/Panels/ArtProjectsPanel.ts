...
export class ArtProjectsPanel
{
    ...
    private createElements(pageParent: HTMLDivElement)
    {
        ...
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "MechaGirl", "images/models/MechaGirl.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "OniGurl", "images/models/OniGurl.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "Jorogumo", "images/models/Jorogumo.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "MechSpider", "images/models/MechSpider.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "GodEater", "images/models/GodEaterChainsaw.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "AnchorSword", "images/models/AnchorSword.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
        this._cells.push(new CellWithPreview(parentNode, cellsPerWidth, "FantasyBow", "images/models/FantasyBow.jpg", (projectName: string, progressBar: HTMLDivElement) => { threeModelView.activateView(projectName, progressBar); }));
