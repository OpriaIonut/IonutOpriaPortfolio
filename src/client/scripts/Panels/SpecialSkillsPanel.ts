...
export class SpecialSkillsPanel
{
    ...
    private createElements(pageParent: HTMLDivElement)
    {
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "Procedural Generation", "Built a 3D engine that generates procedural planets directly in the browser and supports a wide array of unique planets to be generated from a single seed.\nWorked on a procedural volumetric terrain system that is also able to generate underground caves."));
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "VR Development", "Built a couple of VR applications on Occulus Quest 2 using the Unity BNG framework.\nDeveloped a hand gesture & motion recognition system for a game prototype, both for Unity & Unreal Engine."));
        this._skills.push(new WideCellWithDesc(programmingParent, "", "AR Development", "Built 4 AR games for android and iOS devices.\nDeveloped multiple AR applications for the Occulus Quest 3."));
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "Backend Connection & Setup", "Have knowledge about how a backend should work, how you can set it up to receive/send calls to/from it & query information from a database.\nPlayed a big part in deploying the backend & the servers required for the game HEIDI Chocolate on the app store."));
        this._skills.push(new WideCellWithDesc(programmingParent, "", "Multithreaded Programming", "Worked on a couple of projects that made use of multithreading and learned about the rules & best practices that you need to follow when implementing a multithreaded app.\nBuilt a worker system in C++ which is responsible for building resources in a separate thread & returns them in the main thread."));
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "Web Development", "Made this site from scratch using Node.js, Typescript & Three.js for the 3D Visualizer.\nBuild a couple of websites that each made use of Three.js to achieve interesting & unique experiences directly in the browser."));
