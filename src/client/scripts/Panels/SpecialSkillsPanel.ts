...
export class SpecialSkillsPanel
{
    ...
    private createElements(pageParent: HTMLDivElement)
    {
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "VR Development", "Built a couple of VR applications on Occulus Quest 2 using the Unity BNG framework. Developed a hand gesture & motion recognition system for a game prototype."));
        ...
        this._skills.push(new WideCellWithDesc(programmingParent, "", "Android, Desktop, WebGL & VR Deployment", "Deployed multiple applications to the mentioned platforms and have knowledge about what are the hurdles that you have to get through in each of the platforms metioned."));
