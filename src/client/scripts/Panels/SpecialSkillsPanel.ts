...
export class SpecialSkillsPanel
{
    ...
    private createElements()
    {
        ...
        new WideCellWithDesc(programmingParent, "", "Procedural Generation", "Built a 3D engine that procedurally generates planets directly in the browser and supports a wide array of unique planets to be generated from a single seed.<br>Worked on a procedural volumetric terrain system that is also able to generate underground caves.");
        new WideCellWithDesc(programmingParent, "", "Shader Development", "Built complex shaders in GLSL, HLSL & Unity ShaderLab, shaders which include: standard mesh shaders, VFX, PBR lighting, atmosphere simulation, post processing shaders, compute shaders.");
        new WideCellWithDesc(programmingParent, "", "Graphics Programming", "Have some knowledge of low level graphics programming in OpenGL, SFML, SDL2, Sokol & WebGL, including how rendering pipelines should work, how to render objects to the screen, how to dynamically generate meshes at runtime, volumetric terrain generation, etc.");
        ...
        new WideCellWithDesc(programmingParent, "", "Multithreaded Programming", "Have some knowledge of how multithreading should be implemented in an application, including how to build resources in a separate thread, how to guard them, rules you need to follow, etc. Built a worker system which is responsible for building resources in a separate thread & returns them in the main thread.");
        ...
        new WideCellWithDesc(artParent, "", "Retopology", "Retopologized a lot of high-poly sculptures and know how to properly construct the geometry flow to help the texturing/animation process.");
