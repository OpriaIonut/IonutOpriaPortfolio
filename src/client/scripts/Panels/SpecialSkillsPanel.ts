...
export class SpecialSkillsPanel
{
    ...
    private createElements(pageParent: HTMLDivElement)
    {
        ...
        new WideCellWithDesc(programmingParent, "", "Shader Development", "Built complex shaders in GLSL, HLSL & Unity ShaderLab, shaders which include: standard mesh shaders, VFX, PBR lighting, atmosphere simulation, post processing shaders, compute shaders, etc.");
        new WideCellWithDesc(programmingParent, "", "Graphics Programming", "Worked with OpenGL, SFML, SDL2, Sokol & WebGL on a couple of projects and learned a lot of principles related to graphics programming (how rendering pipelines work, object instancing, dynamic mesh generation, volumetric terrain, shaders, etc.)");
